...
interface ConnectedUserSearchBarProps {
    searchQuery: string;
...
export default function ConnectedUserSearchBar({
    searchQuery,
    setSearchQuery,
    searchOption,
    setSearchOption
}: ConnectedUserSearchBarProps) {
    return (
        <div className="relative max-w-6xl mx-auto flex gap-4 p-4">
